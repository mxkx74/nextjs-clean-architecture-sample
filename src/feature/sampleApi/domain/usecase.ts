 ...
 * request model
 */
export const requestModelSchema = z
  .object({
    id: z.string(),
...
// 変換用のmapper
export const convertToSampleRequestModel = (input: SampleRequestParams): SampleRequestModel => {
...
// 変換用のmapper
export const convertToSampleResponseModel = (entity: SampleEntity): SampleResponseModel => {
